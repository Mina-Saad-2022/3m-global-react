          ...
          >
            <div className="about-content ps-0 ps-lg-3">
              ...
              <p className="fst-italic arabic">
                تضمن منتجاتنا التحول الكامل لنهج الزراعة العضوية المستدامة بغرض
                الحفاظ علي البيئة الزراعية المصرية مع ضمان زيادة انتاجية
                المحاصيل والحصول علي منتج زراعي علي الجودة وامن علي صحة المستهلك
              </p>
              <ul>
                <li>
                  <div>
                    ...
                    <p className="arabic">
                      نحرص على تقديم منتجات ذات جودة فائقة تلبيةً لاحتياجات
                      المزارعين والمتخصصين في الزراعة.
                    </p>
                  </div>
                </li>
                <li>
                  <div>
                    ...
                    <p className="arabic">
                      نلتزم بالابتكار وتطوير حلول زراعية جديدة ومتقدمة تساهم في
                      تحقيق أفضل النتائج.
                    </p>
                  </div>
                </li>
